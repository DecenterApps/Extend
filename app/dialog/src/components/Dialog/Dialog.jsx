      ...
      <div styleName="dialog-wrapper">
          ...
          <div>
            ...
            </h1>
            {
              ...
              <h2>
                ...
                This will link your reddit username to your ΞXTΞND Ethereum address.
              </h2>
            }
          </div>
        }
        {
          ...
          <div>
            ...
            <h2>
              Your reddit details have been submitted to the ΞXTΞND smart contract for verification. <br />
