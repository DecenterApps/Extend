...
/* harmony export (immutable) */ __webpack_exports__["SET_ADDRESS"] = SET_ADDRESS;

const SET_NETWORK = 'set_network';
/* harmony export (immutable) */ __webpack_exports__["SET_NETWORK"] = SET_NETWORK;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_symbol_observable__ = __webpack_require__(114);
...
var _reactChromeRedux = __webpack_require__(91);
...
web3.version.getNetwork(function (err, netId) {
  switch (netId) {
    case "1":
      store.dispatch({ type: _types.SET_NETWORK, payload: 'mainnet' });
      break;
    case "2":
      store.dispatch({ type: _types.SET_NETWORK, payload: 'morden' });
      break;
    case "3":
      store.dispatch({ type: _types.SET_NETWORK, payload: 'ropsten' });
      break;
    case "4":
      store.dispatch({ type: _types.SET_NETWORK, payload: 'rinkeby' });
      break;
    case "42":
      store.dispatch({ type: _types.SET_NETWORK, payload: 'kovan' });
      break;
    default:
      store.dispatch({ type: _types.SET_NETWORK, payload: 'unknown' });
  }
});
 ...
 *
 */
var pollForAddressChange = function pollForAddressChange() {
  setInterval(function () {

    if (!web3.eth.accounts[0]) {
      store.dispatch({ type: _types.SET_ADDRESS, payload: '' });
      return;
    }

    if (web3.eth.accounts[0] === store.getState().user.address) return;

    store.dispatch({ type: _types.SET_ADDRESS, payload: web3.eth.accounts[0] });
  }, 100);
};
...
var _userReducer = __webpack_require__(45);
...
exports.default = (0, _redux.combineReducers)({
  count: _count2.default, user: _userReducer2.default
});
...
exports.default = function () {
  ...
  switch (action.type) {
    case _types.SET_ADDRESS:
      return _extends({}, state, { address: payload });

    case _types.SET_NETWORK:
      return _extends({}, state, { network: payload });
...
var constant = __webpack_require__(83),
...
var _wrapStore = __webpack_require__(93);
...
var _assignIn = __webpack_require__(82);
