...
import registerFormValidator from '../RegisterForm/registerFormValidator';
import { createOldUserMessage } from '../../../../messages/userActionsMessages';
import { setOldUserFormTxPriceMessage } from '../../../../messages/formsActionsMessages';

import formStyle from '../../../../commonComponents/forms.scss';

const FORM_NAME = 'oldUserForm';

class OldUserForm extends Component {
  componentWillMount() {
    ...
    return (
      <div>
        <form
          ...
          onSubmit={(e) => { this.props.handleSubmit(e, createOldUserMessage); }}
        >
...
const ExportComponent = createForm(FORM_NAME, OldUserForm, registerFormValidator);
